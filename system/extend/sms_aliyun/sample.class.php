...
class sample{
	...
	public static function send($tel, $param, $template=null){
		...
		$accessKeyId = $G['config']['sms_id'];
		$accessKeySecret = $G['config']['sms_key'];
	
		// fixme 必填: 短信接收号码
		$params["PhoneNumbers"] = $tel;
	
		// fixme 必填: 短信签名，应严格按"签名名称"填写，请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/sign
		$params["SignName"] = $G['config']['sms_sign'];
	
		// fixme 必填: 短信模板Code，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
		$params["TemplateCode"] = $template?$template:$G['config']['sms_template'];
