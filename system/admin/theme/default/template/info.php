...
?>
<?php load::into('head'); ?>
<form id="buy" action="<?php echo url::mpf('template','market','buy'); ?>" method="post" enctype="multipart/form-data">
<?php global $aE; $aE=$G['config']; ?>
<section class="main form">
  <article class="hint">
    <i class="fa fa-info-circle"></i>
    <p>风格模板为源码交易，不支持退款。请谨慎购买！</p>
  </article>
  <aside>
	<div>
	  <dl>
		...
		<dd>
		  <?php echo form::radio('id',$data['id'],null,array($data['id']=>$data['name'])); ?>
          <cite><?php echo $data['title']; ?></cite>
		</dd>
	  </dl>
	  <dl>
		<dt>
